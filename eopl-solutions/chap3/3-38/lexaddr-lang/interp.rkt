...
;;;;;;;;;;;;;;;; the interpreter ;;;;;;;;;;;;;;;;
    ...
    (lambda (exp nameless-env)
      (cases expression exp
        ...
        (cond-exp (lefts rights)
          (cond-val lefts rights nameless-env))
  ...
  (define cond-val
    (lambda (lefts rights nameless-env)
      (cond
        [(null? lefts)
         (eopl:error 'cond-val
                     "No left-hand is true")]
        [(expval->bool (value-of (car lefts) nameless-env))
         (value-of (car rights) nameless-env)]
        [else
         (cond-val (cdr lefts) (cdr rights) nameless-env)])))
